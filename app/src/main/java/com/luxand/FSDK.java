...
public class FSDK
{
    ...
    public static native int MatchFaces(FSDK_FaceTemplate FaceTemplate1, FSDK_FaceTemplate FaceTemplate2);
    ...
    public static native int GetTrackerFacePosition(HTracker Tracker, long CameraIdx, long faceID, TFacePosition FacePosition);
